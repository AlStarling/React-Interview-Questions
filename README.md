...
<ul>
<li><b>==</b> (нестрогое равенство): Сравнивает значения после автоматического преобразования типов.</li>
<li><b>===</b> (строгое равенство): Сравнивает значения без преобразования типов, учитывая их тип и значение.</li>
</ul>
</details>
<details>
<summary></summary>
